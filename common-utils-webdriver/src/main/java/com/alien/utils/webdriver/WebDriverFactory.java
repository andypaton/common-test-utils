...
public final class WebDriverFactory {
    ...
    public static WebDriver getWebDriver() throws IOException, InstantiationException, IllegalAccessException{
...
//        		default: WEB_DRIVER = getFirefoxDriver();
        		...
        		case CHROME: driverClass = ChromeDriver.class; break;
        		case FIREFOX: driverClass = FirefoxDriver.class; break;
        		case PHANTOMJS: driverClass = PhantomJSDriver.class; break;
        	
        		default: driverClass = FirefoxDriver.class;
        	}

        		WebDriverManager.getInstance(driverClass).setup();
        		
        		WEB_DRIVER = driverClass.newInstance();
